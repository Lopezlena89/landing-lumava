...
import { CiBrightnessDown,CiInstagram,CiMail } from 'react-icons/ci'
  ...
  return (
    <>
        ...
        >
            ...
            <li className=" flex items-center justify-evenly lg:justify-end md:text-[13px] lg:text-base w-[88%] text-purple-200">
                <Link
